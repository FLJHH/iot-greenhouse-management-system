...
#define EnableINT()
#define DisableINT()
#define DS_PORT Sensor_Port_Ds18b20
#define DS_DQIO Sensor_Pin_Ds18b20
#define DS_RCC_PORT Sensor_Rcc_Ds18b20
