...
extern unsigned int GlobalVar_sensor_SD_cesu;
extern unsigned int GlobalVar_sensor_DO_diedao ;
...
extern unsigned int GlobalVar_sensor_hongwai_juli ;
...
extern unsigned char GlobalVar_sensor_key16_vlaue;
extern unsigned int GlobalVar_sensor_online_response;
extern unsigned int GlobalVar_sensor_interval_time ;
extern unsigned int GlobalVar_sensor_sudu ;
extern unsigned int GlobalVar_sensor_juli ;
extern int GlobalVar_sensor_ph_dan_lin_jia_PH ;
extern int GlobalVar_sensor_ph_dan_lin_jia_DAN ;
extern int GlobalVar_sensor_ph_dan_lin_jia_LIN ;
extern int GlobalVar_sensor_ph_dan_lin_jia_JIA ;

extern int GlobalVar_sensor_liuliang_enter ;
extern int GlobalVar_sensor_liuliang_output ;

extern unsigned int GlobalVar_sensor_beep_init ;
extern unsigned int GlobalVar_sensor_beep_interval ;


extern unsigned char GlobalVar_flag_is_inited_zhendong_DO ;
extern unsigned int GlobalVar_sensor_zhendong_AO ;



//-----------------------------
//自动调节变量
extern unsigned char GlobalVar_flag_auto_adjust_RX ;
extern unsigned char GlobalVar_flag_auto_adjust_tds ;
extern unsigned char GlobalVar_flag_auto_adjust_wendu ;
extern unsigned char GlobalVar_flag_auto_adjust_moshi ;
extern unsigned char GlobalVar_flag_auto_adjust_churuku ;
...
extern unsigned char GlobalVar_flag_ms53lom_inited;
...
extern unsigned char GlobalVar_flag_is_inited_zhendong_DO ;
extern unsigned char GlobalVar_flag_is_inited_zhendong_AO;
extern unsigned char GlobalVar_flag_ph_dan_lin_jia_inited ;
extern unsigned char GlobalVar_flag_sudu_inited ;
extern unsigned char GlobalVar_flag_key16_inited ;
extern unsigned char GlobalVar_flag_liuliang_inited ;
extern unsigned char GlobalVar_flag_motor_inited ;
//-----------------------------
//阈值变量
...
extern unsigned int GlobalVar_sensor_key_state;

extern unsigned int GlobalVar_sensor_alert_auto_timer1;
extern unsigned int GlobalVar_sensor_alert_t_start1;
extern unsigned int GlobalVar_sensor_alert_t_end1;
extern unsigned int GlobalVar_Threshold_alert_data1 ;
extern unsigned int GlobalVar_Threshold_alert_data2 ;
extern unsigned int GlobalVar_Threshold_alert_data3 ;
extern unsigned int GlobalVar_Threshold_alert_data4 ;
extern unsigned int GlobalVar_Adjust_key_select_state1 ;
extern unsigned int GlobalVar_Adjust_key_select_state4 ;
extern unsigned int GlobalVar_Adjust_key_select_line ;
extern unsigned int GlobalVar_Adjust_key_modify_number1 ;
extern unsigned int GlobalVar_Adjust_key_modify_number2 ;
extern unsigned int GlobalVar_Adjust_key_modify_number3 ;
extern unsigned int GlobalVar_Adjust_key_modify_number4 ;
extern unsigned char MOTOR_Direction_Control;
...
void GetSensor_MQ3(char *name); // A00
void GetSensor_MQ4(char *name); // A00
void GetSensor_Ziwaixian(char *name); //ziwaixian  AO6
void GetSensor_Yudi_1(char *name);//yudi  AO1
void GetSensor_Yudi_2(char *name);
void GetSensor_Shuiwei_1(char *name); //shuwei AO0
...
void GetSensor_hongwai_duiguan_1(char *name);//B13
void GetSensor_hongwai_duiguan_2(char *name);//B13
void GetSensor_hongwai_duiguan_3(char *name);//B13
void GetSensor_hongwai_duiguan_4(char *name);//B13
void GetSensor_hongwai_duiguan_5(char *name);//B13
void GetSensor_hongwai_duiguan_6(char *name);//B13
...
void GetSensor_ph_dan_lin_jia(char * ph ,char * dan,char * lin , char * jia);//串口A9-TX   A10-RX  9600波特率
void GetSensor_ms53lom_juli(char *name); //串口A9-TX   A10-RX
...
void SetSensor_SD_cesu(char *name ); //sd_测速，
void GetSensor_maichongjishu(char * name ); //脉冲计数
void GetSensor_liuliang(char *enter, char *output);

void SetSensor_Jidianqi_1(unsigned char value); //B5
void SetSensor_Jidianqi_2(unsigned char value); //B6
void SetSensor_Jidianqi_3(unsigned char value); //B7
void SetSensor_Jidianqi_4(unsigned char value); //B8
void SetSensor_Deng_1(unsigned char value); //B9
void SetSensor_Deng_2(unsigned char value);//B12
void SetSensor_Deng_3(unsigned char value);//B13
void SetSensor_Deng_4(unsigned char value);//B14
void SetSensor_Beep_1(unsigned char value); //B10
void SetSensor_Beep_interval_1(unsigned char value); //B10
void SetSensor_Fan_1(unsigned char value);//B14
void SetSensor_Fan_2(unsigned char value);//B15
...
void SetSensor_float_wendu(const char *value);//获取下发温度(带3位小数)
...
void process_liuliang_100ms(void);
void process_zhendong_AO_1ms(void);
