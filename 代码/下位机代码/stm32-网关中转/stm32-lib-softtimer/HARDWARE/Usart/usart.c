...
#if defined (Open_UART1)
    USART_InitStructure.USART_BaudRate = BaudRate_UART1;
...
#if defined (Open_UART2)
    USART_InitStructure.USART_BaudRate = BaudRate_UART2;
    USART_InitStructure.USART_WordLength = USART_WordLength_8b;
    USART_InitStructure.USART_StopBits = USART_StopBits_1;
    USART_InitStructure.USART_Parity = USART_Parity_No;
    USART_InitStructure.USART_HardwareFlowControl = USART_HardwareFlowControl_None;
...
#if defined (Open_UART3)
    USART_InitStructure.USART_BaudRate = BaudRate_UART3;
    USART_InitStructure.USART_WordLength = USART_WordLength_8b;
    USART_InitStructure.USART_StopBits = USART_StopBits_1;
    USART_InitStructure.USART_Parity = USART_Parity_No;
    USART_InitStructure.USART_HardwareFlowControl = USART_HardwareFlowControl_None;
...
//串口1发送数组
void UART1_Send_BUFF(const uint8_t *Buf, uint16_t PackLen)
{
    uint16_t i;
    for(i=0; i<PackLen; i++)
    {
...
//串口2发送数组
void UART2_Send_BUFF(const uint8_t *Buf, uint16_t PackLen)
{
    uint16_t i;
    for(i=0; i<PackLen; i++)
    {
...
//串口3发送数组
void UART3_Send_BUFF(const uint8_t *Buf, uint16_t PackLen)
{
    uint16_t i;
    for(i=0; i<PackLen; i++)
    {
