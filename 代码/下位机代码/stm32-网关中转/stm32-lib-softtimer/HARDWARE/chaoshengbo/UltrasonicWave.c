...
void UltrasonicWave_Configuration(void)
{
  ...
  #if defined (OPEN_UltrasonicWave_CH1)
  ...
  #if defined (OPEN_UltrasonicWave_CH2)
  ...
  #if defined (OPEN_UltrasonicWave_CH3)
  ...
  #if defined (OPEN_UltrasonicWave_CH4)
...
void EXTI9_5_IRQHandler(void)
{
  ...
  if (EXTI_GetITStatus(EXTI_Line7) != RESET)
  {
    ...
    while (GPIO_ReadInputDataBit(ECHO_PORT_ch1, ECHO_PIN_ch1));                //等待低电平
  ...
  if (EXTI_GetITStatus(EXTI_Line5) != RESET)
  {
    ...
    while (GPIO_ReadInputDataBit(ECHO_PORT_ch2, ECHO_PIN_ch2));                //等待低电平
...
void EXTI3_IRQHandler(void)
{
  ...
  if (EXTI_GetITStatus(EXTI_Line3) != RESET)
  {
    ...
    while (GPIO_ReadInputDataBit(ECHO_PORT_ch3, ECHO_PIN_ch3));                //等待低电平
...
void EXTI1_IRQHandler(void)
{
  ...
  if (EXTI_GetITStatus(EXTI_Line1) != RESET)
  {
    ...
    while (GPIO_ReadInputDataBit(ECHO_PORT_ch4, ECHO_PIN_ch4));                //等待低电平
