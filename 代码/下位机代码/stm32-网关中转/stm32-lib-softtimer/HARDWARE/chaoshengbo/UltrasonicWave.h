...
//#define OPEN_UltrasonicWave_CH1 
// #define OPEN_UltrasonicWave_CH2 
#define OPEN_UltrasonicWave_CH3 
// #define OPEN_UltrasonicWave_CH4 
...
void UltrasonicWave_Init(void);  //超声波初始化
