...
extern struct protocol_pipe protocol_pipe_uart_1;
...
void USART1_IRQHandler(void)
{
  ...
  { 
    ...
    protocol_pipe_put(&protocol_pipe_uart_1, &value, 1);

    // rb_write(&card_rb,&value,1);  //激光扫码
    // rb_write(&hongwai_rb,&value,1); //红外体温
